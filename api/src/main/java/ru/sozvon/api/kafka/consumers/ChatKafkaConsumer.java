...
public class ChatKafkaConsumer extends BaseKafkaConsumer {
    ...
    @Autowired
    public ChatKafkaConsumer(KafkaProducer kafkaProducer, ObjectMapper objectMapper, DtoConverter dtoConverter) {
        super(kafkaProducer, objectMapper, dtoConverter);
    }

    @KafkaListener(topics = "db-api_chat_response", groupId = "api_chat_request_group")
