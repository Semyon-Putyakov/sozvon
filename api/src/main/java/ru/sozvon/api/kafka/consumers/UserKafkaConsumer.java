...
public class UserKafkaConsumer extends BaseKafkaConsumer {
    ...
    @Autowired
    public UserKafkaConsumer(KafkaProducer kafkaProducer, ObjectMapper objectMapper, DtoConverter dtoConverter) {
        super(kafkaProducer, objectMapper, dtoConverter);
    }

    @KafkaListener(topics = "db-api_user_response", groupId = "api_user_request_group")
